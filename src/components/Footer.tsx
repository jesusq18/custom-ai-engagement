        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#demo" className="text-white/60 hover:text-neon transition-colors duration-300">
                  Demo
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-white/60">
                ...
                <a href="mailto:contato@iaatendimento.com" className="hover:text-neon transition-colors duration-300">
                  contato@iaatendimento.com
                </a>
              </li>
              <li className="flex items-center text-white/60">
                <svg className="w-5 h-5 mr-2 text-neon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="tel:+551199999999" className="hover:text-neon transition-colors duration-300">
                  +55 11 99999-9999
                </a>
              </li>
              <li className="mt-4">
                <div className="flex space-x-4">
                  <a href="#" className="text-white/60 hover:text-neon transition-colors duration-300">
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-white/50 text-sm mb-4 md:mb-0">
              © {currentYear} IAatendimento. Todos os direitos reservados.
            </p>
